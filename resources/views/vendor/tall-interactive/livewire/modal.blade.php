...
<div class="relative z-[999]" id="{{ $actionableId }}">
    {{-- Modal --}}
    <div class="tall-interactive-modal fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0 sm:block">
            ...
            <div
                class="tall-interactive-modal-body inline-block align-bottom bg-white text-black rounded-lg text-left shadow-xl transform transition-all sm:my-8 sm:align-middle {{ $maxWidth }} sm:w-[calc(100%-24px)]"
                x-show="state"
            ...
            >
                @if($dismissable)
                    <div class="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                        <button type="button" wire:click="$emit('modal:close', '{{ $actionableId }}')"
                                class="bg-none hover:bg-gray-100 p-1 rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                ...
                @if($showControls)
                    <div
                        class="bg-gray-50 px-4 py-3 sm:px-6 flex-shrink-0 flex justify-end gap-2 flex-wrap rounded-b-[inherit]"
